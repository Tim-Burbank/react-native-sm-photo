...
public class OpenCameraException extends Exception {
    private final static String TAG = "OpenCameraException";
    ...
    public enum OpenType {
        INUSE("Camera disabled or in use by other process"), NOCAMERA(
    ...
    public void printStackTrace() {
        LogUtils.e(TAG, LOG_PREFIX + mType.getMessage());

...
package com.yunio.videocapture.configration;
...
public class PredefinedCaptureConfigurations {
    ...
    public static final int WIDTH_360P = 360;
    public static final int HEIGHT_360P = 640;
    ...
    public static final int WIDTH_480P = 480;
    public static final int HEIGHT_480P = 640;
    ...
    public static final int WIDTH_720P = 720;
    public static final int HEIGHT_720P = 1280;
    ...
    public static final int WIDTH_1080P = 1080;
    public static final int HEIGHT_1080P = 1920;
    ...
    public static final int WIDTH_1440P = 1440;
    public static final int HEIGHT_1440P = 2560;
    ...
    public static final int WIDTH_2160P = 2160;
    public static final int HEIGHT_2160P = 3840;
    ...
    public enum CaptureResolution {
        ...
        RES_720P(WIDTH_720P, HEIGHT_720P, BITRATE_HQ_720P, BITRATE_MQ_720P, BITRATE_LQ_720P), // HD
                                                                                              // ready
        ...
        private CaptureResolution(int width, int height, int highBitrate, int medBitrate,
                int lowBitrate) {
            this.width = width;
            this.height = height;

...
public class EasyPermission {
    ...
    public EasyPermission positveButtonText(int positiveButtonText) {
        this.mPositiveButtonText = positiveButtonText;
        return this;
    }

    public EasyPermission nagativeButtonText(int negativeButtonText) {
     ...
     * it.
     */
    public static void requestPermissions(final Object object, String rationale, int positiveButton,
            int negativeButton, final int requestCode, final String... permissions) {
        ...
        final List<String> deniedPermissions = PermissionUtils
                .findDeniedPermissions(PermissionUtils.getActivity(object), permissions);
        ...
        for (String perm : deniedPermissions) {
            shouldShowRationale = shouldShowRationale
                    || PermissionUtils.shouldShowRequestPermissionRationale(object, perm);
        }

        if (PermissionUtils.isEmpty(deniedPermissions)) {
            mCallBack.onEasyPermissionGranted(requestCode, permissions);
        } else {
            final String[] deniedPermissionArray = deniedPermissions
    ...
    public static boolean checkDeniedPermissionsNeverAskAgain(final Object object, String rationale,
            String... deniedPerms) {
        return checkDeniedPermissionsNeverAskAgain(object, rationale, android.R.string.ok,
                android.R.string.cancel, null, deniedPerms);
    }
    ...
    public static boolean checkDeniedPermissionsNeverAskAgain(final Object object, String rationale,
            ...
            DialogInterface.OnClickListener negativeButtonOnClickListener, String... deniedPerms) {
        boolean shouldShowRationale;
        for (String perm : deniedPerms) {
            shouldShowRationale = PermissionUtils.shouldShowRequestPermissionRationale(object,
                    perm);
